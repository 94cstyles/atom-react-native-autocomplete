...
var COMPONENT = {
    ...
    hasTagScope: function hasTagScope(scopes) {
        return this.hasScopeDescriptor(scopes, ['meta.scope.tag.block', 'meta.tag.block.begin.jsx', 'meta.tag.block.end.jsx', 'entity.name.tag.jsx']) && !this.hasScopeDescriptor(scopes, ['invalid.illegal.tag.end.jsx']);
    },
    ...
    hasAttributeValueScope: function hasAttributeValueScope(scopes) {
        return this.hasScopeDescriptor(scopes, ['string.quoted.double.jsx', 'string.quoted.single.jsx', 'string.quoted.double.js', 'string.quoted.single.js']) && this.hasScopeDescriptor(scopes, ['meta.scope.inner', 'punctuation.definition.string.begin.jsx', 'punctuation.definition.string.end.jsx']);
    },
    hasAttributeContentScope: function hasAttributeContentScope(scopes) {
        return this.hasScopeDescriptor(scopes, ['punctuation.section.embedded.begin.jsx', 'punctuation.section.embedded.end.jsx', 'meta.embedded.expression.jsx', /meta.embedded.expression.(\S*).jsx/]);
    },
